...
int main()
{
	...
	deleteMemory(NULL, SIZE_LIST);
}
 
char** allocList(int sizeList)
{
	if (malloc(sizeList * sizeof(char*) == NULL))
	{
		return 0;
	}
	else
...
void allocLastName(char** list, int sizeList)
{
	if (list == 0)
	{
		printf("The wrong pointer in function allocLastName. The pointer should'n equal NULL\n");
		return 0;
	}
...
void addList(char** list, int sizeList)
{
	if (list == 0)
	{
		printf("The wrong pointer in function addList. The pointer should'n equal NULL\n");
		return 0;
	}
	for (int i = 0; i < sizeList; i++)
	{
...
void sort(char** list, int sizeList)
{
	if (list == 0)
	{
		printf("The wrong pointer in function sort. The pointer should'n equal NULL\n");
		return 0;
	}
	char* buff = NULL;
...
void printList(char** list, int sizeList)
{
	if (list == 0)
	{
		printf("The wrong pointer in function printList. The pointer should'n equal NULL\n");
		return 0;
	}
	for (int i = 0; i < sizeList; i++)
	{
